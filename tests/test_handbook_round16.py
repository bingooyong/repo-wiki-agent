...
def test_english_mock_pages_skip_handbook_structure_gate() -> None:
    english = (
        "# Sample Page\n\n## 简介\n\n"
        "This page was generated by a fake provider for circuit-break scheduler tests.\n"
    )
    assert (
        handbook_structure_gate_applies(english, path="docs/sample.md", title="Sample Page")
        is False
    )
    assert (
        handbook_structure_gate_applies(_TINY_IDE, path="开发指南/IDE配置.md", title="IDE配置")
        is True
    )
