...
- [系统架构](../architecture/index.md) - 服务是架构的具体实现
- [API 参考](../api/index.md) - 服务通过 API 对外暴露接口
- [数据模型](../data-model/index.md) - 服务的业务逻辑依赖数据模型
